...
export default function Social() {
    return (
        <div className='my-4'>
            <a className='rounded-full inline-block p-2.5 bg-slate-200'>
                <FaLinkedinIn className='text-primary text-lg ' />
            </a>
            <a className='rounded-full inline-block p-2.5 bg-slate-200 ml-6'>
                <FaInstagram className='text-primary text-lg' />
            </a>
            <a className='rounded-full inline-block p-2.5 bg-slate-200 ml-6'>
                <FaFacebookF className='text-primary text-lg' />
            </a>
            <a className='rounded-full inline-block p-3 bg-slate-200 ml-6'>
                <svg
                    width='15'
                    height='16'
                    viewBox='0 0 15 16'
